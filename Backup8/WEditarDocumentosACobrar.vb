...
Public Class WEditarDocumentosACobrar

#Region "Propietarios"
    Public wCtaCte1 As New WDocumentosACobrar
#End Region
...
#End Region
    ...
    Sub GrabarCuenta10EnDetalle()
        ...
        ent10.DebeHaberRegContabDeta = "Debe"
    ...
    Sub GrabarDiferenciaCambio()
        ...
        xdebe = Dgv.SumarColumna(Me.DgvDocPen, cam.MonSol, "")
        xhaber = Dgv.SumarColumna(Me.DgvDocPen, cam.ImpSolRCC, "")
    ...
    Sub Aceptar()
        ...
        MsgBox("Se realizo el cobranza correctamente Numero Voucher Ingreso es: " + ent.NumeroVoucherRegContabCabe, MsgBoxStyle.Information, "Cobranza")
        Me.Close()
