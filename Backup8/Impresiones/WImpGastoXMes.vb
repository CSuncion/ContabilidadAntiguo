...
Public Class WImpGastoXMes
    ...
    Sub Imprimir()
        ...
        ds.GastoXMes.Clear()
        'Llenar Cabecera()
        periodo = CType(Me.CrGastoXMes1.Section2.ReportObjects.Item("Periodo"), CrystalDecisions.CrystalReports.Engine.TextObject)
        periodo.Text = "Del mes de " + Me.txtDesMes.Text + " a " + Me.TxtDesMes1.Text + " del " + Me.txtAno.Text

        empresa = CType(Me.CrGastoXMes1.Section2.ReportObjects.Item("Empresa"), CrystalDecisions.CrystalReports.Engine.TextObject)
        empresa.Text = Me.txtNomEmp.Text

        cue = CType(Me.CrGastoXMes1.Section2.ReportObjects.Item("cue"), CrystalDecisions.CrystalReports.Engine.TextObject)
        ...
        Me.CrGastoXMes1.SetDataSource(ds)
        'Cargamos en nuestro formulario el cr
        Me.crv1.ReportSource = Me.CrGastoXMes1
