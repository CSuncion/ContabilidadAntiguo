...
Public Class TipoCambioAD
    ...
    Sub SetParametros(ByRef ent As SuperEntidad)
        '//
        Sql.AsignarParametro(Par.FechaTipoCambio, ent.FechaTipoCambio)
        Sql.AsignarParametro(Par.CompraTipoCambio, ent.CompraTipoCambio)
        Sql.AsignarParametro(Par.VentaTipoCambio, ent.VentaTipoCambio)
        Sql.AsignarParametro(Par.CompraEurTipoCambio, ent.CompraEurTipoCambio)
        Sql.AsignarParametro(Par.VentaEurTipoCambio, ent.VentaEurTipoCambio)
        Sql.AsignarParametro(Par.MesTipoCambio, ent.MesTipoCambio)
        Sql.AsignarParametro(Par.AnoTipoCambio, ent.AnoTipoCambio)
        Sql.AsignarParametro(Par.DolarEuroTipoCambio, ent.DolarEuroTipoCambio)
    ...
    Function Objeto(ByRef iDr As IDataReader) As SuperEntidad
        ...
        objEnc.FechaTipoCambio = CType(iDr(Campo.FecTipCam), DateTime)
        objEnc.CompraTipoCambio = CType(iDr(Campo.ComTipCam), Decimal)
        objEnc.VentaTipoCambio = CType(iDr(Campo.VenTipCam), Decimal)
        objEnc.CompraEurTipoCambio = CType(iDr(Campo.ComEurTipCam), Decimal)
        objEnc.VentaEurTipoCambio = CType(iDr(Campo.VenEurTipCam), Decimal)
        objEnc.DolarEuroTipoCambio = CType(iDr(Campo.DolEurTipCam), Decimal)

        objEnc.MesTipoCambio = iDr(Campo.MesTipCam).ToString
        objEnc.AnoTipoCambio = iDr(Campo.AnoTipCam).ToString
        'estado
        ...
        'especial
        objEnc.CampoCursor = CType(iDr(Campo.FecTipCam), DateTime).Day.ToString + "/" + CType(iDr(Campo.FecTipCam), DateTime).Month.ToString + "/" + CType(iDr(Campo.FecTipCam), DateTime).Year.ToString
        Return objEnc
        '\\
    End Function


    Sub SpNuevoTipoCambio(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpNuevoTipoCambio")
            '/Asignar Parametros
    ...
    Sub SpModificarTipoCambio(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpModificarTipoCambio")
            '/Asignar Parametros
            Me.SetParametros(ent)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
    ...
    Sub SpEliminarTipoCambio(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpEliminarTipoCambio")
            '/Asignar Parametro
            Sql.AsignarParametro(Par.FechaTipoCambio, ent.FechaTipoCambio)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
