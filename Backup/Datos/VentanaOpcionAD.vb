...
Public Class VentanaOpcionAD
      ...
      Sub SpNuevoVentanaOpcion(ByRef ent As SuperEntidad)
            '//
            Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)

            Sql.ComandoProcAlm("SpNuevoVentanaOpcion")
            '/Asignar Parametros
    ...
    Sub SpModificarVentanaOpcion(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpModificarVentanaOpcion")
            '/Asignar Parametros
            Me.SetParametros(ent)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
    ...
    Sub SpEliminarVentanaOpcion(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpEliminarVentanaOpcion")
            Sql.AsignarParametro(Par.CodigoOpcion, ent.CodigoOpcion)
            Sql.AsignarParametro(Par.CodigoVentana, ent.CodigoVentana)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
