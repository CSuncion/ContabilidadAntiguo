...
Public Class WExportarRegistroMayorNuevo
    ...
    Sub hilo1()
        ...
        For Each xObj As SuperEntidad In iLisRcc
            ...
            If xObj.ImporteSRegContabDeta <> 0 Then
                ...
                linea += "|"
                'Campo 5 Unidad Economica
                linea += " |"
                'Campo 6 Centro de costos de la unidad
                linea += " |"
                'Campo 7 Moneda
                ...
                'Campo 9 
                linea += " |"
                'Campo 10 tipo documento
                If xObj.TipoDocumento = String.Empty Then
                    linea += "00"
                Else
                    If xObj.TipoDocumento = "38" Or xObj.TipoDocumento = "39" Or xObj.TipoDocumento = "32" Or xObj.TipoDocumento = "36" Or xObj.TipoDocumento = "34" Or xObj.TipoDocumento = "CH" Or xObj.TipoDocumento = "35" Or xObj.TipoDocumento = "21" Or xObj.TipoDocumento = "22" Or xObj.TipoDocumento = "23" Or xObj.TipoDocumento = "25" Or xObj.TipoDocumento = "33" Or xObj.TipoDocumento = "40" Or xObj.TipoDocumento = "50" Or xObj.TipoDocumento = "52" Then
                        If xObj.TipoDocumento = "CH" Then
                            MsgBox(xObj.TipoDocumento + "---" + xObj.ClaveRegContabCabe, MsgBoxStyle.Critical)
                        End If
                        linea += "00"
                    Else
