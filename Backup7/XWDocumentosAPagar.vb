...
Public Class XWDocumentosAPagar
    ...
    Public titulo As String = "Documentos a Pagar"
...
#Region "Metodos"
    ...
    Sub ActualizarDgvTab()
        ...
        lista = ccte.obtenerCuentaCorrienteExis(ent)
    ...
    Sub modificar()
        ...
        '    Dim cod As String = Dgv.obtenerValorCelda(Me.DgvCtaCte, 0)
