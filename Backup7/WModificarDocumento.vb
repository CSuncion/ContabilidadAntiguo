Imports Entidad
Imports Negocio
Public Class WModificarDocumento
#Region "Propietarios"
...
#Region "Metodos"
    ...
    Sub ModificarMovimientoDetalle()
        ...
        For Each xMcd As SuperEntidad In iListMcd
            xMcd.TipoDocumento = Me.txtDoc.Text
            xMcd.SerieDocumento = Me.txtSer.Text
            xMcd.NumeroDocumento = Me.txtNum.Text
            xMcd.CodigoAuxiliar = Me.txtCodAux.Text
...
#End Region
    ...
    Private Sub WModificarDocumento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
