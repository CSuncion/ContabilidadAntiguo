Public Class Accion
    ...
    'Listo
    Sub EstadoBotonesPorGrilla(listaBotones As List(Of ListaTsb), ByRef lis As List(Of ListaTsb), ByRef Dgv As DataGridView)
        '//
    ...
    End Sub
    'Listo
    Sub EstadoBotonesPorFillaGrilla(listaBotones As List(Of ListaTsb), ByRef lis As List(Of ListaTsb), ByRef Dgv As DataGridView)
        '//
        For Each tsb As ListaTsb In lis
