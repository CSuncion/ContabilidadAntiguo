...
Public Class WListarPeriodos
    Public lista As New List(Of SuperEntidad)
    Public ent, entpar As New SuperEntidad
    Dim periRN As New PeriodoRN
...
#Region "Metodos"
    ...
    Sub ActualizarDgvLista()
        ...
        Select Case Me.tabla
            ...
            Case "PeriodosActivos"
                lista = periRN.ListarPeriodosActivas(ent)
        ...
        Dgv.asignarColumnaText(Me.DgvLista, cam.CodPer, "Periodo", 75)
        Dgv.asignarColumnaText(Me.DgvLista, cam.NMesPer, "Mes", 250)
        '\\
    End Sub
    ...
    Sub DevolverDatos()
        ...
        Else
            ...
            Me.txt1.Text = Dgv.obtenerValorCelda(Me.DgvLista, cam.CodPer)
