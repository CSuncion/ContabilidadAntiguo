...
#Region "Metodos"
    ...
    Sub ActualizarDgvLista()
        ...
        Select Case Me.CondicionLista
            Case "UsuariosActivos"
                lista = usu.obtenerUsuariosExiAct(ent)
            Case "UsuariosExistentes"
        ...
        Dgv.asignarColumnaText(Me.DgvLista, cam.CodUsu, "Codigo", 90)
        Dgv.asignarColumnaText(Me.DgvLista, cam.NomUsu, "Descripcion", 210)
        '\\
    End Sub
    ...
    Sub DevolverDatos()
        ...
        Else
            ...
            Me.txt1.Text = ent.CodigoUsuario
            Me.txt2.Text = ent.NombreUsuario
...
#End Region
    ...
    '    Dim texto As String = Me.txtBus.Text.Trim
    '    Dgv.buscarEnColumna(Me.DgvLista, ent.CampoOrden, texto)
    'End Sub
