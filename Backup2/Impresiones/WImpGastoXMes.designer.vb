...
Partial Class WImpGastoXMes
    ...
    Private Sub InitializeComponent()
        ...
        Me.CrGastoXMes1 = New Presentacion.CrGastoXMes
    ...
    Friend WithEvents CrGastoXMes1 As Presentacion.CrGastoXMes
End Class
