...
Public Class WImpGastoXMesExpor
    ...
    Sub Imprimir()
        ...
        ds.GastoXMes.Clear()
        'Llenar Cabecera()
        periodo = CType(Me.CrGastoXMesExpor1.Section2.ReportObjects.Item("Periodo"), CrystalDecisions.CrystalReports.Engine.TextObject)
        periodo.Text = "Del mes de " + Me.txtDesMes.Text + " a " + Me.TxtDesMes1.Text + " del " + Me.txtAno.Text

        empresa = CType(Me.CrGastoXMesExpor1.Section2.ReportObjects.Item("Empresa"), CrystalDecisions.CrystalReports.Engine.TextObject)
        empresa.Text = Me.txtNomEmp.Text

        cue = CType(Me.CrGastoXMesExpor1.Section2.ReportObjects.Item("cue"), CrystalDecisions.CrystalReports.Engine.TextObject)
        ...
        ilisRes = iMovConDetRN.ReporteGastosXMes(iMovConDetEN)

        For Each obj As SuperEntidad In ilisRes

            Dim NewRow As DataSet1.GastoXMesRow
            NewRow = ds.GastoXMes.NewGastoXMesRow
            NewRow.Codigo = obj.CodigoCuentaPcge
            NewRow.Nombre = obj.NombreCuentaPcge
            NewRow.Codigo1 = obj.CodigoCuentaBanco
            NewRow.Nombre1 = obj.NombreCuenta1242
            NewRow.Enero = obj.HabeS01SaldoContable
            NewRow.Febrero = obj.HabeS02SaldoContable
            NewRow.Marzo = obj.HabeS03SaldoContable
            NewRow.Abril = obj.HabeS04SaldoContable
            NewRow.Mayo = obj.HabeS05SaldoContable
            NewRow.Junio = obj.HabeS06SaldoContable
            NewRow.Julio = obj.HabeS07SaldoContable
            NewRow.Agosto = obj.HabeS08SaldoContable
            NewRow.Setiembre = obj.HabeS09SaldoContable
            NewRow.Octubre = obj.HabeS10SaldoContable
            NewRow.Noviembre = obj.HabeS11SaldoContable
            NewRow.Diciembre = obj.HabeS12SaldoContable
            NewRow.Total = obj.SaldoCuentaCorriente
            'AGREGANDO REGISTROS AL DATATABLE
            'LLENANDO EL REGISTRO
            'AÑADIR AL DS
            ds.GastoXMes.Rows.Add(NewRow)

        Next

        Me.CrGastoXMesExpor1.SetDataSource(ds)
        'Cargamos en nuestro formulario el cr
        Me.crv1.ReportSource = Me.CrGastoXMesExpor1
