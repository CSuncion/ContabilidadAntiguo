...
Public Class WImportarDocumentos

    Public lista As New List(Of SuperEntidad)
    Public aux As New TablaRN
        ...
        If Me.dgvExcel.Rows.Count <> 1 Then
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                If Me.dgvExcel.Item(0, n).Value.ToString <> "" Then
                    ...
                    entd.TipoTabla = "Doc" '' Me.dgvExcel.Item(0, n).Value.ToString
                    entd.CodigoItemTabla = Me.dgvExcel.Item(1, n).Value.ToString
                    entd.NombreItemTabla = Me.dgvExcel.Item(2, n).Value.ToString
                    entd.EstadoRegistro = "1"
                    entd.Exporta = "0"
                    aux.nuevoItemTabla(entd)
