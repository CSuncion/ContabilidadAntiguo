...
Public Class WImportarDataMesesDetalle
        ...
        If Me.dgvExcel.Rows.Count <> 1 Then
            ...
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                Else
                    ...
                    Else
                        entd.SerieDocumento = "0" + Me.dgvExcel.Item(17, n).Value.ToString.PadLeft(3, CType("0", Char))
                    End If
                End If
                ...
                If entd.CodigoOrigen = "4" Then
                    ...
                    'MsgBox(entd.CodigoAuxiliar)

                    If entd.CodigoCuentaPcge.Substring(0, 2) = "40" Or entd.CodigoCuentaPcge.Substring(0, 2) = "42" Or entd.CodigoCuentaPcge.Substring(0, 2) = "43" Then
                ...
                '  entd.CodigoCuentaPcge = Me.dgvExcel.Item(6, n).Value.ToString.Trim
                entd.CodigoGastoReparable = Me.dgvExcel.Item(28, n).Value.ToString.Trim
                If xcant <> "" Then
                    entd.Cantidad = CType(Me.dgvExcel.Item(13, n).Value.ToString, Decimal)
                Else
                    entd.Cantidad = 0
                End If
                entd.Exporta = "0"
            ...
            Next
        End If
        MsgBox("La importacion del DETALLE se realizo con exito")
