...
Public Class WCopiaPlanCuentas
#Region "Propietarios"
...
#Region "Metodos"
    ...
    End Sub
      ...
      Function EmpresaCopiaConCuentas() As Boolean
            ...
            If obE.CodigoEmpresa = "" Then
                  Return True
            Else
                  Dim listCueEmp As New List(Of SuperEntidad)
                  obE.CampoOrden = cam.CodCtaPcge
                  listCueEmp = empCue.obtenerCuentaExisPorEmpresa(obE)
                  If listCueEmp.Count = 0 Then
                        MsgBox("Esta empresa no tiene cuentas para copiar", MsgBoxStyle.Exclamation, Me.titulo)
                        Me.ObtenerEmpresa(emp.EmpresaIni)
                        Me.txtCodEmpC.Focus()
                        Return False
                  Else
      ...
      Function EmpresaBaseConCuentas() As Boolean
            Dim obE As New SuperEntidad
            obE.CodigoEmpresa = Me.txtCodEmp.Text.Trim
            If empCue.existeCuentasEnEmpresa(obE) = True Then
                  Return True
            Else
                  Return False
            End If
    ...
    Sub Copia()
        ...
        If Me.EmpresaBaseConCuentas() = True Then
            'Preguntar si se desea remplazar
            Dim rpta As Integer = MsgBox("La empresa de codigo : " + Me.txtCodEmp.Text.Trim + " ya tiene cuentas deseas reemplazarlas", MsgBoxStyle.YesNo, Me.titulo)
            ...
            End If
        Else
            Dim rpta As Integer = MsgBox("Deseas copiar el plan de cuentas", MsgBoxStyle.YesNo, Me.titulo)
            If rpta = MsgBoxResult.Yes Then
                'Adicionar las nuevas cuentas
                Me.AdicionarCuentas()
            Else
    ...
    End Sub
      ...
      Sub AdicionarCuentas()
            ...
            obE.CodigoEmpresa = Me.txtCodEmpC.Text.Trim
            obE.CampoOrden = cam.CodCtaPcge
            lis = empCue.obtenerCuentaExisPorEmpresa(obE)
      ...
      Sub EliminarCuentasEmpresaBase()
            ...
            Dim obE As New SuperEntidad
            obE.CodigoEmpresa = Me.txtCodEmp.Text.Trim
            empCue.eliminarCuentasPorEmpresaFis(obE)
      End Sub
