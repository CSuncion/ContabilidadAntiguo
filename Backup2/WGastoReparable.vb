...
Public Class WGastoReparable
    ...
    Public titulo As String = "Item Almacen"
...
#Region "Metodos"
    ...
    Sub permisoVentana()
        Dim nReg As Integer = Me.DgvGasRep.Rows.Count
    ...
    Sub ActualizarVentana()
        '//
        Me.ActualizarDgvTab()
        Dgv.actualizarBarraEstado(Me.sst1, Me.DgvGasRep)
        acc.EstadoBotonesPorGrilla(Me.ListaBotones, Me.DgvGasRep)
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvGasRep)
        Dgv.pintarColumnaDgv(Me.DgvGasRep, ent.CampoOrden)
        Me.permisoVentana()
        '\\
    End Sub
    ...
    Sub ActualizarDgvTab()
        ...
        lista = GasR.obtenerGastoReparableExisXEmpresa(ent)

        '/Refrescando el DataSource de DgvUsu
        Dgv.refrescarFuenteDatosGrilla(Me.DgvGasRep, lista)
        '/Creando las columnas
        Dgv.asignarColumnaText(Me.DgvGasRep, cam.CodGasRep, "Codigo", 60)
        Dgv.asignarColumnaText(Me.DgvGasRep, cam.NomGasRep, "Nombre", 290)
        Dgv.asignarColumnaText(Me.DgvGasRep, cam.CodUni, "Unidad", 80)
        Dgv.asignarColumnaText(Me.DgvGasRep, cam.EstGasRep, "Estado", 110)
        Dgv.asignarColumnaTextVis(Me.DgvGasRep, cam.ClaGasRep, "Clave", 60, 0)
        '//
    End Sub
    ...
    Sub adicionar()
        '//
        Dim win As New WEditarGastoReparable
        win.wGasRep = Me
        win.operacion = 0
        Me.AddOwnedForm(win)
    ...
    Sub modificar()
        ...
        Dim cod As String = Dgv.obtenerValorCelda(Me.DgvGasRep, cam.ClaGasRep)
...
#End Region
    ...
    Private Sub DgvDis_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvGasRep.CellEnter
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvGasRep)
    End Sub

    Private Sub DgvDis_ColumnHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DgvGasRep.ColumnHeaderMouseClick
        ent.CampoOrden = Me.DgvGasRep.Columns(e.ColumnIndex).Name
        ent.ColumnaBusqueda = Me.DgvGasRep.Columns(e.ColumnIndex).HeaderText
        Me.ActualizarVentana()
    End Sub
    ...
    Private Sub btnDesplaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrimero.Click, btnAnterior.Click, btnSiguiente.Click, btnUltimo.Click
        Dgv.desplazamientoFila(Me.DgvGasRep, CType(sender, ToolStripButton))
    End Sub
