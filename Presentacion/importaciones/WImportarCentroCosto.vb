...
Public Class WImportarCentroCosto

    Public lista As New List(Of SuperEntidad)
    Public aux As New CentroCostoRN
        ...
        If Me.dgvExcel.Rows.Count <> 1 Then
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                If Me.dgvExcel.Item(0, n).Value.ToString <> "" Then
                    ...
                    ' entd.CodigoEmpresa = Me.dgvExcel.Item(0, n).Value.ToString
                    entd.CodigoEmpresa = SuperEntidad.xCodigoEmpresa
                    entd.CodigoCentroCosto = Me.dgvExcel.Item(1, n).Value.ToString
                    entd.ClaveCentroCosto = entd.CodigoEmpresa + entd.CodigoCentroCosto
                    entd.NombreCentroCosto = Me.dgvExcel.Item(2, n).Value.ToString
                    entd.EstadoCentroCosto = "1"
                    entd.EstadoRegistro = "1"
                    entd.Exporta = "0"
                    aux.nuevaCentroCosto(entd)

                End If

            Next
        End If
        MsgBox("La importacion TABLA DOCUMENTOS se realizo con exito")
