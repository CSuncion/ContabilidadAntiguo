...
Public Class WIngresoEgreso
    ...
    Public titulo As String = "IngresoEgreso"
...
#Region "Metodos"
    ...
    Sub ActualizarVentana()
        '//
        Me.ActualizarDgvTab()
        Dgv.actualizarBarraEstado(Me.sst1, Me.DgvIngEgr)
        acc.EstadoBotonesPorGrilla(Me.ListaBotones, Me.DgvIngEgr)
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvIngEgr)
        Dgv.pintarColumnaDgv(Me.DgvIngEgr, ent.CampoOrden)
        Me.permisoVentana()
        '\\
    End Sub
    ...
    Sub ActualizarDgvTab()
        ...
        lista = IngEgr.obtenerIngresoEgresoExisXEmpresa(ent)

        '/Refrescando el DataSource de DgvUsu
        Dgv.refrescarFuenteDatosGrilla(Me.DgvIngEgr, lista)
        '/Creando las columnas
        Dgv.asignarColumnaText(Me.DgvIngEgr, cam.CodIngEgr1, "Codigo", 60)
        Dgv.asignarColumnaText(Me.DgvIngEgr, cam.NomIngEgr1, "Nombre", 290)
        Dgv.asignarColumnaText(Me.DgvIngEgr, cam.EstIngEgr, "Estado", 110)
        Dgv.asignarColumnaTextVis(Me.DgvIngEgr, cam.ClaIngEgr, "Clave", 60, 0)
    ...
    Sub adicionar()
        '//
        Dim win As New WEditarIngresoEgreso
        win.wIngEgr = Me
        win.operacion = 0
        Me.AddOwnedForm(win)
    ...
    Sub modificar()
        ...
        Dim cod As String = Dgv.obtenerValorCelda(Me.DgvIngEgr, cam.ClaIngEgr)
...
#End Region
    ...
    Private Sub DgvDis_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvIngEgr.CellEnter
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvIngEgr)
    End Sub

    Private Sub DgvDis_ColumnHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DgvIngEgr.ColumnHeaderMouseClick
        ent.CampoOrden = Me.DgvIngEgr.Columns(e.ColumnIndex).Name
        ent.ColumnaBusqueda = Me.DgvIngEgr.Columns(e.ColumnIndex).HeaderText
        Me.ActualizarVentana()
    End Sub
    ...
    Private Sub btnDesplaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrimero.Click, btnAnterior.Click, btnSiguiente.Click, btnUltimo.Click
        Dgv.desplazamientoFila(Me.DgvIngEgr, CType(sender, ToolStripButton))
    End Sub
