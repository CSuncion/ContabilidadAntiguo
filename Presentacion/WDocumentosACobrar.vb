...
Public Class WDocumentosACobrar
...
#Region "Varios"
    ...
    Sub MostrarDocumentosDelAuxiliar()
        ...
        If CodAux = "11111111111" Then
            lista = ccte.ListarDocumentosACobrarXEmpresaYPendientes(obj)
        Else
            lista = ccte.ListarDocumentosACobrarXEmpresaXAuxiliarYPendientes(obj)
        End If
    ...
    Sub adicionar()
        '/
        Dim win As New WEditarDocumentosACobrar
        win.wCtaCte1 = Me
        win.operacion = 0
        Me.AddOwnedForm(win)
            ...
            Case "US$"
                ...
                For Each xobj As SuperEntidad In Me.Lista1
                    If xobj.MonedaDocumento = "EUR" Then
                        MsgBox("Si la moneda de cobranza es dolar ningun documento a cobrar debe ser euro", MsgBoxStyle.Exclamation, "moneda")
                        Return False
                    End If
                Next
            ...
            Case "EUR"
                ...
                For Each xobj As SuperEntidad In Me.Lista1
                    If xobj.MonedaDocumento = "US$" Then
                        MsgBox("Si la moneda de cobranza es euro ningun documento a cobrar debe ser dolar", MsgBoxStyle.Exclamation, "moneda")
                        Return False
                    End If
                Next
                'SI NO ENCONTRO NINGUN EURO ENTONCES MANDA VERDADERO
