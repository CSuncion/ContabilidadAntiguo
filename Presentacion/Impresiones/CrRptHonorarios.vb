...
Public Class CrRptHonorarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptHonorarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptHonorarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptHonorarios = New CrRptHonorarios()
        rpt.Site = Me.Site
        Return rpt
    End Function
