...
Public Class CrGastoXMesExpor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrGastoXMesExpor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrGastoXMesExpor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrGastoXMesExpor = New CrGastoXMesExpor()
        rpt.Site = Me.Site
        Return rpt
    End Function
