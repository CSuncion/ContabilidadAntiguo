...
Public Class CrRptVoucher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptVoucher = New CrRptVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
