...
Public Class CrSaldoBanco
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrSaldoBanco.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSaldoBanco
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSaldoBanco = New CrSaldoBanco()
        rpt.Site = Me.Site
        Return rpt
    End Function
