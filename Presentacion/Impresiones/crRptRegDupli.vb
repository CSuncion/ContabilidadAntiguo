...
Public Class crRptRegDupli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.crRptRegDupli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRptRegDupli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRptRegDupli = New crRptRegDupli()
        rpt.Site = Me.Site
        Return rpt
    End Function
