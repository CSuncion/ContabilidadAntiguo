...
Public Class WImpAnalisisAuxiliaresResumenNuevo
    ...
    Dim ano, mes, empresa, periodo, periodo1, cuenta, nombrecuenta, ruc As CrystalDecisions.CrystalReports.Engine.TextObject
    ...
    Sub Imprimir()
        ...
        cuenta.Text = Me.TxtCodCta.Text

        nombrecuenta = CType(Me.cr.Section2.ReportObjects.Item("NombreCuenta"), CrystalDecisions.CrystalReports.Engine.TextObject)
        nombrecuenta.Text = Me.TxtNomCta.Text
