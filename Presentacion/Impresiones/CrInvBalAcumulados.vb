...
Public Class CrInvBalAcumulados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrInvBalAcumulados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrInvBalAcumulados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrInvBalAcumulados = New CrInvBalAcumulados()
        rpt.Site = Me.Site
        Return rpt
    End Function
