...
Public Class CrRptFormatos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptFormatos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptFormatos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptFormatos = New CrRptFormatos()
        rpt.Site = Me.Site
        Return rpt
    End Function
