...
Public Class CrReporteMesDifCam
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrReporteMesDifCam.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrReporteMesDifCam
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrReporteMesDifCam = New CrReporteMesDifCam()
        rpt.Site = Me.Site
        Return rpt
    End Function
