...
Public Class CrGastoAnalisis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrGastoAnalisis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrGastoAnalisis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrGastoAnalisis = New CrGastoAnalisis()
        rpt.Site = Me.Site
        Return rpt
    End Function
