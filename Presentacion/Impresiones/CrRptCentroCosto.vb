...
Public Class CrRptCentroCosto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptCentroCosto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptCentroCosto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptCentroCosto = New CrRptCentroCosto()
        rpt.Site = Me.Site
        Return rpt
    End Function
