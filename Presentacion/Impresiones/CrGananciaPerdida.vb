...
Public Class CrGananciaPerdida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrGananciaPerdida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrGananciaPerdida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrGananciaPerdida = New CrGananciaPerdida()
        rpt.Site = Me.Site
        Return rpt
    End Function
