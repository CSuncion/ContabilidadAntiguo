...
Public Class CrRptVoucher1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptVoucher1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptVoucher1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptVoucher1 = New CrRptVoucher1()
        rpt.Site = Me.Site
        Return rpt
    End Function
