...
#End Region
    ...
    Public plan As New PlanCuentaGeRN
    Public par As New ParametroRN
    Dim cam As New CamposEntidad
    Dim ds As New DataSet1
    Dim tb As New DataTable
    Dim cr As New CrRptPcge
    ...
    Sub Imprimir()
        ...
        lista = plan.obtenerCuentaExisPorEmpresa(obPl)
        ...
        For Each obj As SuperEntidad In lista
            ...
            If obj.CodigoCuentaPcge >= cuenta1 And obj.CodigoCuentaPcge <= cuenta2 Then
                ...
                NewRow.documento = obj.FlagDocumentoPcge
                NewRow.auxiliar = obj.FlagAuxiliarPcge
                NewRow.costo = obj.FlagCentroCostoPcge
                NewRow.almacen = obj.FlagAlmacenPcge
                NewRow.area = obj.FlagAreaPcge
                NewRow.flujo = obj.FlagFlujoCajaPcge
                NewRow.Automatica = obj.FlagAutomaticaPcge
                NewRow.Automatica1 = obj.CuentaAutomatica1Pcge
                NewRow.Automatica2 = obj.CuentaAutomatica2Pcge
                NewRow.diferencia = obj.FlagDifCambioPcge
                NewRow.banco = obj.FlagBancoPcge
                NewRow.formato = obj.ClaveFormatoContable
