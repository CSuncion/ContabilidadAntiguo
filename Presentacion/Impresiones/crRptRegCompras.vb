...
Public Class crRptRegCompras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.crRptRegCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRptRegCompras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRptRegCompras = New crRptRegCompras()
        rpt.Site = Me.Site
        Return rpt
    End Function
