...
Public Class CrRptRegistroVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptRegistroVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptRegistroVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptRegistroVenta = New CrRptRegistroVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
