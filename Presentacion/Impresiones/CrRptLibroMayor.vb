...
Public Class CrRptLibroMayor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptLibroMayor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptLibroMayor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptLibroMayor = New CrRptLibroMayor()
        rpt.Site = Me.Site
        Return rpt
    End Function
