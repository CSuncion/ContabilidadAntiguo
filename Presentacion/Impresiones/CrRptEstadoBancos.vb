...
Public Class CrRptEstadoBancos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRptEstadoBancos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRptEstadoBancos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRptEstadoBancos = New CrRptEstadoBancos()
        rpt.Site = Me.Site
        Return rpt
    End Function
