...
Public Class WSumaIngEgr
    ...
    Public titulo As String = "SumaIngEgr"
...
#Region "Metodos"
    ...
    Sub NuevaVentana()
        ...
        Me.Show()
        'orden por defecto
        ent.CampoOrden = cam.CodSumIngEgr
    ...
    Sub ActualizarVentana()
        '//
        Me.ActualizarDgvTab()
        Dgv.actualizarBarraEstado(Me.sst1, Me.DgvSumIngEgr)
        acc.EstadoBotonesPorGrilla(Me.ListaBotones, Me.DgvSumIngEgr)
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvSumIngEgr)
        Dgv.pintarColumnaDgv(Me.DgvSumIngEgr, ent.CampoOrden)
        Me.permisoVentana()
        '\\
    End Sub
    ...
    Sub ActualizarDgvTab()
        ...
        lista = IngEgr.obtenerSumaIngEgrExisXEmpresa(ent)

        '/Refrescando el DataSource de DgvUsu
        Dgv.refrescarFuenteDatosGrilla(Me.DgvSumIngEgr, lista)
        '/Creando las columnas
        Dgv.asignarColumnaText(Me.DgvSumIngEgr, cam.CodSumIngEgr, "Codigo", 60)
        Dgv.asignarColumnaText(Me.DgvSumIngEgr, cam.NomSumInEgr, "Nombre", 290)
        Dgv.asignarColumnaText(Me.DgvSumIngEgr, cam.EstSumIngEgr, "Estado", 110)
        Dgv.asignarColumnaTextVis(Me.DgvSumIngEgr, cam.ClaSumIngEgr, "Clave", 60, 0)
        '//
    End Sub
    ...
    Sub adicionar()
        '//
        Dim win As New WEditarSumaIngEgr
        win.wSumIngEgr = Me
        win.operacion = 0
        Me.AddOwnedForm(win)
    ...
    Sub modificar()
        ...
        Dim cod As String = Dgv.obtenerValorCelda(Me.DgvSumIngEgr, cam.ClaSumIngEgr)
...
#End Region
    ...
    Private Sub DgvDis_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvSumIngEgr.CellEnter
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvSumIngEgr)
    End Sub

    Private Sub DgvDis_ColumnHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DgvSumIngEgr.ColumnHeaderMouseClick
        ent.CampoOrden = Me.DgvSumIngEgr.Columns(e.ColumnIndex).Name
        ent.ColumnaBusqueda = Me.DgvSumIngEgr.Columns(e.ColumnIndex).HeaderText
        Me.ActualizarVentana()
    End Sub
    ...
    Private Sub btnDesplaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrimero.Click, btnAnterior.Click, btnSiguiente.Click, btnUltimo.Click
        Dgv.desplazamientoFila(Me.DgvSumIngEgr, CType(sender, ToolStripButton))
    End Sub
