...
Public Class WImportarBoletasVenta
    ...
    Sub Grabar()
        ...
        If Me.dgvExcel.Rows.Count <> 1 Then
            ...
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                entc.TipoDocumento = Me.dgvExcel.Item(0, n).Value.ToString
                entc.SerieDocumento = Me.dgvExcel.Item(1, n).Value.ToString.PadLeft(4, CType("0", Char))
                entc.NumeroDocumento = Me.dgvExcel.Item(2, n).Value.ToString.PadLeft(15, CType("0", Char)) ''+ "-" + Me.dgvExcel.Item(3, n).Value.ToString.PadLeft(7, CType("0", Char))
                entc.FechaDocumento = CType(Me.dgvExcel.Item(4, n).Value.ToString, Date)
                entc.DiaVoucherRegContabCabe = entc.FechaVoucherRegContabCabe.Day.ToString.PadLeft(2, CType("0", Char))
                entc.FechaVctoDocumento = Me.dgvExcel.Item(4, n).Value.ToString
                entc.MonedaDocumento = Me.dgvExcel.Item(17, n).Value.ToString
                entc.TipoDocumento1 = ""
                entc.SerieDocumento1 = ""
                entc.NumeroDocumento1 = ""
                entc.FechaDocumento1 = ""
                entc.MonedaDocumento1 = "0"
                entc.VentaTipoCambio = CType(Me.dgvExcel.Item(11, n).Value.ToString, Decimal)
                entc.VentaEurTipoCambio = 1
                entc.IgvPar = ParEnt.IgvPar
                entc.PrecioVtaRegContabCabe = CType(Me.dgvExcel.Item(10, n).Value.ToString, Decimal)
                entc.IgvRegContabCabe = CType(Me.dgvExcel.Item(9, n).Value.ToString, Decimal)
                entc.ExoneradoRegContabCabe = CType(Me.dgvExcel.Item(8, n).Value.ToString, Decimal)
                ...
                entc.PrecioVtaSolRegContabCabe = CType(Me.dgvExcel.Item(15, n).Value.ToString, Decimal)
                entc.IgvSolRegContabCabe = CType(Me.dgvExcel.Item(14, n).Value.ToString, Decimal)
                entc.ExoneradoSolRegContabCabe = CType(Me.dgvExcel.Item(13, n).Value.ToString, Decimal)
                ...
                Else
                    entc.GlosaRegContabCabe = Me.dgvExcel.Item(19, n).Value.ToString
                End If
