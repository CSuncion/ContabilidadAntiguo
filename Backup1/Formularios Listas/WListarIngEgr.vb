...
Public Class WListarIngEgr
    Public lista As New List(Of SuperEntidad)
    Public ent, entpar As New SuperEntidad
    Dim IngEgrRN As New IngresoEgresoRN
...
#Region "Metodos"
    ...
    Sub ActualizarDgvLista()
        ...
        Select Case Me.tabla
            ...
            Case "IngresoEgreso"
                ...
                lista = IngEgrRN.obtenerIngresoEgresoExisXEmpresa(ent)
        ...
        Dgv.asignarColumnaText(Me.DgvLista, cam.CodIngEgr1, "Codigo", 75)
        Dgv.asignarColumnaText(Me.DgvLista, cam.NomIngEgr1, "Nombre", 250)
        Dgv.asignarColumnaTextVis(Me.DgvLista, cam.ClaIngEgr, "Clave", 80, 0)
    ...
    Sub DevolverDatos()
        ...
        Else
            ...
            Me.txt1.Text = Dgv.obtenerValorCelda(Me.DgvLista, cam.CodIngEgr1)
