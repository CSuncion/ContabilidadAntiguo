...
Public Class WListarCentroCostos
    Public lista As New List(Of SuperEntidad)
    Public ent, entpar As New SuperEntidad
    Dim CCosRN As New CentroCostoRN
...
#Region "Metodos"
    ...
    Sub ActualizarDgvLista()
        ...
        Select Case Me.tabla
            ...
            Case "CentroCosto"
                ...
                lista = CCosRN.obtenerCentroCostoExisXEmpresa(ent)
        ...
        Dgv.asignarColumnaText(Me.DgvLista, cam.CodCenCto, "Codigo", 75)
        Dgv.asignarColumnaText(Me.DgvLista, cam.NomCenCto, "Nombre", 250)
        Dgv.asignarColumnaTextVis(Me.DgvLista, cam.ClaCenCto, "Clave", 80, 0)
    ...
    Sub DevolverDatos()
        ...
        Else
            ...
            Me.txt1.Text = Dgv.obtenerValorCelda(Me.DgvLista, cam.CodCenCto)
