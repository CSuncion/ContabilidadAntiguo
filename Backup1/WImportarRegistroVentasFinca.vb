...
Public Class WImportarRegistroVentasFinca
    ...
    Sub PorDefecto()
        ...
        Me.TxtCodOriVta.Text = ParEnt.CCodigoOrigenRegistroVentas
        Me.TxtCodFilVta.Text = ParEnt.CCodigoFileRegistroVentas
        Me.TxtCtaPreVta.Text = ParEnt.CuentaMontoTotalCuotas
        Me.TxtCtaCuoOrd.Text = ParEnt.CuentaCuotaOrdinaria
        Me.TxtCtaCuoSupPro.Text = ParEnt.CuentaCuotaSupervisionYProyectos
        'Me.TxtCtaCuoAgu.Text = ParEnt.CuentaCuotaAgua
        'Me.TxtCtaCuoEle.Text = ParEnt.CuentaCuotaElectricidad
        'Me.TxtCtaCuoIng.Text = ParEnt.CuentaCuotaIngreso
        'Me.TxtCtaCuoExt.Text = ParEnt.CuentaCuotaExtraordinaria
        'Me.TxtCtaCuoMor.Text = ParEnt.CuentaCuotaMoras
    ...
    Sub EliminarAntesDeProcesar()
        ...
        iRcc.CodigoOrigen = ParEnt.CCodigoOrigenRegistroVentas
        iRcc.CodigoFile = ParEnt.CCodigoFileRegistroVentas
        ...
        iRcd.ClaveRegContabCabe += ParEnt.CCodigoOrigenRegistroVentas
        iRcd.ClaveRegContabCabe += ParEnt.CCodigoFileRegistroVentas
        ...
        iCcte.ClaveCuentaCorriente += ParEnt.CCodigoOrigenRegistroVentas
        iCcte.ClaveCuentaCorriente += ParEnt.CCodigoFileRegistroVentas
    ...
    Sub Grabar()
        ...
        Dim wPeriodo As String = String.Empty
        ...
        Dim wExonerado As Decimal = 0
        Dim wIgv As Decimal = 0
        Dim wNumero As Integer = 0 'Convert.ToInt32(Me.TxtNumero.Text) - 1

        ''Empezando a Grabar
        If Me.dgvExcel.Rows.Count <> 1 Then

            ''Valida Periodo Del Sistema y del Excel
            wPeriodo = Me.dgvExcel.Item(62, 0).Value.ToString

            If (wPeriodo <> Me.TxtPeri.Text) Then
                MsgBox("Periodo del sistema: " + Me.TxtPeri.Text.Trim + " Periodo del Excel: " + wPeriodo, MsgBoxStyle.Critical, "Verifique Información")
                Return
            End If
            ...
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                entc.CodigoOrigen = ParEnt.CCodigoOrigenRegistroVentas
                entc.CodigoFile = ParEnt.CCodigoFileRegistroVentas

                wNumero += 1 ''Numero Voucher

                entc.NumeroVoucherRegContabCabe = CType(wNumero, String).PadLeft(6, CType("0", Char))

                entc.FechaVoucherRegContabCabe = CType(Me.dgvExcel.Item(6, n).Value.ToString, Date)
                ...
                entc.CodigoAuxiliar = Me.dgvExcel.Item(4, n).Value.ToString
                entc.SegundoNombreAuxiliar = Me.dgvExcel.Item(3, n).Value.ToString
                If (entc.SegundoNombreAuxiliar = "DNI") Then
                    If (entc.CodigoAuxiliar.Length = 7) Then
                        entc.CodigoAuxiliar = "0" + entc.CodigoAuxiliar
                    End If
                Else
                    If (entc.SegundoNombreAuxiliar = "CARNET EXT.") Then
                        entc.CodigoAuxiliar = "000" + entc.CodigoAuxiliar
                    End If
                End If
                entc.DescripcionAuxiliar = Me.dgvExcel.Item(5, n).Value.ToString
                entc.TipoDocumento = Me.dgvExcel.Item(2, n).Value.ToString
                If (entc.TipoDocumento = "BOLETA DE VENTA") Then
                    entc.TipoDocumento = "03"
                Else
                    entc.TipoDocumento = "07"
                End If
                entc.SerieDocumento = Me.dgvExcel.Item(0, n).Value.ToString.PadLeft(4, CType("0", Char))
                entc.NumeroDocumento = Me.dgvExcel.Item(1, n).Value.ToString.PadLeft(15, CType("0", Char))
                entc.FechaDocumento = CType(Me.dgvExcel.Item(6, n).Value.ToString, Date)
                entc.DiaVoucherRegContabCabe = entc.FechaVoucherRegContabCabe.Day.ToString.PadLeft(2, CType("0", Char))
                entc.FechaVctoDocumento = Me.dgvExcel.Item(6, n).Value.ToString
                entc.MonedaDocumento = Me.dgvExcel.Item(7, n).Value.ToString
                If (entc.MonedaDocumento = "PEN") Then
                    entc.MonedaDocumento = "0"
                Else
                    entc.MonedaDocumento = "1"
                End If
                If (entc.TipoDocumento = "07") Then   ''Nota De Credito
                    entc.TipoDocumento1 = "03"
                    entc.SerieDocumento1 = Me.dgvExcel.Item(52, n).Value.ToString
                    entc.NumeroDocumento1 = Me.dgvExcel.Item(53, n).Value.ToString
                    entc.FechaDocumento1 = Me.dgvExcel.Item(54, n).Value.ToString
                Else
                    entc.TipoDocumento1 = ""
                ...
                End If
                entc.VentaTipoCambio = CType(Me.dgvExcel.Item(39, n).Value.ToString, Decimal)
                entc.VentaEurTipoCambio = 0
                entc.IgvPar = ParEnt.IgvPar

                ''Importes del comprobante de pago
                entc.PrecioVtaRegContabCabe = CType(Me.dgvExcel.Item(8, n).Value.ToString, Decimal)
                entc.IgvRegContabCabe = 0
                entc.ExoneradoRegContabCabe = entc.PrecioVtaRegContabCabe
                entc.ValorVtaRegContabCabe = 0

                entc.PrecioVtaSolRegContabCabe = CType(Me.dgvExcel.Item(41, n).Value.ToString, Decimal)
                entc.IgvSolRegContabCabe = 0
                entc.ExoneradoSolRegContabCabe = entc.PrecioVtaSolRegContabCabe
                entc.ValorVtaSolRegContabCabe = 0

                If (entc.PrecioVtaSolRegContabCabe = 0) Then
                    entc.GlosaRegContabCabe = "ANULADO"
                Else
                    entc.GlosaRegContabCabe = "Ingresos del periodo " + entc.PeriodoRegContabCabe 'Me.dgvExcel.Item(19, n).Value.ToString
                End If
                ...
                If entc.CodigoAuxiliar <> "" Then
                    ...
                    If ent.CodigoAuxiliar = "" Then
                        ...
                        ent.SegundoNombreAuxiliar = "G.H.V."
                        ...
                        ent.TipoAuxiliar = "3"
                        'ent.TipoDocumentoAuxiliar = Me.dgvExcel.Item(4, n).Value.ToString
                ...
                ''Grabar Detalle 1
                ''Primero la cuenta precio venta el total del comprobante
                ...
                'End If
                entd.ImporteDRegContabDeta = 0 ''(entc.ValorVtaRegContabCabe + entc.ExoneradoRegContabCabe) / entc.VentaTipoCambio
                ...
                ''Detalle Datos Variables 1 Precio Venta
                If CType(Me.dgvExcel.Item(41, n).Value.ToString, Decimal) <> 0 Then
                    entd.CorrelativoRegContabDeta = "0001"
                    entd.ClaveRegContabDeta = entc.ClaveRegContabCabe + entd.CorrelativoRegContabDeta
                    entd.CodigoCuentaPcge = Me.ParEnt.CuentaMontoTotalCuotas
                    If (entc.TipoDocumento = "07") Then
                        entd.DebeHaberRegContabDeta = "0" 'Haber
                        entd.GlosaRegContabDeta = "Devolucion del propietario Periodo: " + Me.TxtPeri.Text
                    Else
                        entd.DebeHaberRegContabDeta = "1" ''Debe
                        entd.GlosaRegContabDeta = "Ingreso total del propietario Periodo: " + Me.TxtPeri.Text
                    End If
                    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(41, n).Value.ToString, Decimal)

                    ''Graba Registro Precio Venta
                    rCD.nuevoRegContabDeta(entd)
                End If

                ''Detalle Datos Variables 2 Valor Venta o Exonerado
                If entc.ExoneradoSolRegContabCabe <> 0 Then
                    entd.CorrelativoRegContabDeta = "0002"
                    entd.ClaveRegContabDeta = entc.ClaveRegContabCabe + entd.CorrelativoRegContabDeta
                    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaOrdinaria
                    If (entc.TipoDocumento = "07") Then
                        entd.DebeHaberRegContabDeta = "1" ''Debe
                        entd.GlosaRegContabDeta = "Devolucion por conceptos del propietario Periodo: " + Me.TxtPeri.Text
                    Else
                        entd.DebeHaberRegContabDeta = "0" ''Haber
                        entd.GlosaRegContabDeta = "Ingreso por conceptos del propietario Periodo: " + Me.TxtPeri.Text
                    End If
                    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(41, n).Value.ToString, Decimal)

                    ''Graba Registro Valores Venta 
                    rCD.nuevoRegContabDeta(entd)
                End If

                ''Detalle Datos Variables 3 Valor IGV
                'If entc.IgvSolRegContabCabe <> 0 Then
                '    entd.CorrelativoRegContabDeta = "0003"
                '    entd.ClaveRegContabDeta = entc.ClaveRegContabCabe + entd.CorrelativoRegContabDeta
                '    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaSupervisionYProyectos
                '    entd.DebeHaberRegContabDeta = "0" ''Debe
                '    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(8, n).Value.ToString, Decimal)
                '    entd.GlosaRegContabDeta = "Ingreso por concepto de Supervisión y Revisión de Proyectos Periodo: " + Me.TxtPeri.Text
                '    ''Graba Registro Valores Venta
                '    rCD.nuevoRegContabDeta(entd)
                'End If

                ' ''Detalle Datos Variables 4 ''Cuota agua
                'If CType(Me.dgvExcel.Item(8, n).Value.ToString, Decimal) <> 0 Then
                '    entd.CorrelativoRegContabDeta = "0004"
                '    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaAgua
                '    entd.DebeHaberRegContabDeta = "0" ''Haber
                '    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(8, n).Value.ToString, Decimal)
                '    entd.GlosaRegContabDeta = "Ingreso por concepto de Cuota de Agua Periodo: " + Me.TxtPeri.Text
                '    ''Graba Registro Valores Venta
                '    rCD.nuevoRegContabDeta(entd)
                'End If

                ' ''Detalle Datos Variables 5 Cuota Elctricidad
                'If CType(Me.dgvExcel.Item(9, n).Value.ToString, Decimal) <> 0 Then
                '    entd.CorrelativoRegContabDeta = "0005"
                '    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaElectricidad
                '    entd.DebeHaberRegContabDeta = "0" ''Haber
                '    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(9, n).Value.ToString, Decimal)
                '    entd.GlosaRegContabDeta = "Ingreso por concepto de Cuota de Electricida Periodo: " + Me.TxtPeri.Text
                '    ''Graba Registro Valores Venta
                '    rCD.nuevoRegContabDeta(entd)
                'End If

                ' ''Detalle Datos Variables 6 Cuota Ingreso
                'If CType(Me.dgvExcel.Item(10, n).Value.ToString, Decimal) <> 0 Then
                '    entd.CorrelativoRegContabDeta = "0006"
                '    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaIngreso
                '    entd.DebeHaberRegContabDeta = "0" ''Haber
                '    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(10, n).Value.ToString, Decimal)
                '    entd.GlosaRegContabDeta = "Ingreso por concepto de Cuota de Ingreso Periodo: " + Me.TxtPeri.Text
                '    ''Graba Registro Valores Venta
                '    rCD.nuevoRegContabDeta(entd)
                'End If

                ' ''Detalle Datos Variables 7 Cuota ExtraOrdinaria
                'If CType(Me.dgvExcel.Item(11, n).Value.ToString, Decimal) <> 0 Then
                '    entd.CorrelativoRegContabDeta = "0007"
                '    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaExtraordinaria
                '    entd.DebeHaberRegContabDeta = "0" ''Haber
                '    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(11, n).Value.ToString, Decimal)
                '    entd.GlosaRegContabDeta = "Ingreso por concepto de Cuota Extraordinaria Periodo: " + Me.TxtPeri.Text
                '    ''Graba Registro Valores Venta
                '    rCD.nuevoRegContabDeta(entd)
                'End If

                ' ''Detalle Datos Variables 8 Cuota Moras
                'If CType(Me.dgvExcel.Item(12, n).Value.ToString, Decimal) <> 0 Then
                '    entd.CorrelativoRegContabDeta = "0008"
                '    entd.CodigoCuentaPcge = Me.ParEnt.CuentaCuotaExtraordinaria
                '    entd.DebeHaberRegContabDeta = "0" ''Haber
                '    entd.ImporteSRegContabDeta = CType(Me.dgvExcel.Item(12, n).Value.ToString, Decimal)
                '    entd.GlosaRegContabDeta = "Ingreso por concepto de Cuota Moras Periodo: " + Me.TxtPeri.Text
                '    ''Graba Registro Valores Venta
                '    rCD.nuevoRegContabDeta(entd)
                'End If
            ...
            aut.CodigoFile = ParEnt.CCodigoFileRegistroVentas
