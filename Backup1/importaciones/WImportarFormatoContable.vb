...
Public Class WImportarFormatoContable

    Public lista As New List(Of SuperEntidad)
    Public aux As New FormatoContableRN
        ...
        If Me.dgvExcel.Rows.Count <> 1 Then
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                If Me.dgvExcel.Item(0, n).Value.ToString <> "" Then
                    ...
                    entd.CodigoFormatoContable = Me.dgvExcel.Item(1, n).Value.ToString
                    entd.ClaveFormatoContable = entd.CodigoEmpresa + entd.CodigoFormatoContable
                    entd.DescripcionFormatoContable = Me.dgvExcel.Item(2, n).Value.ToString
                    entd.GrupoFormatoContable = "1"
                    entd.NaturalezaFormatoContable = "1"
                    entd.ImporteSolesFormatoContable = 0
                    entd.ImporteDolaresFormatoContable = 0
                    entd.ImporteEurosFormatoContable = 0
                    entd.EstadoFormatoContable = "1"
                    entd.EstadoRegistro = "1"
                    entd.Exporta = "0"
                    aux.nuevaFormatoContable(entd)
