...
Public Class WImportarRegistroCompras
...
#Region "Metodos"
    ...
    Function ConvertirTextoARegistroCompras() As List(Of SuperEntidad)
        ...
        'UNO A UNO
        Dim iLisRegCon As New List(Of SuperEntidad)
            ...
            If iLineaActual <> Nothing Then
                If iLineaActual.Length <> 0 Then
                    ...
                    If iLineaActual.Substring(0, 1) = "C" Then
                        ...
                        iRccEN = iRccRN.ConvertirTextoARegistroCompraCabe(iLineaActual)
                        'PASAR ESTA CABECERA A LA LISTA iLisAsi
                        iLisRegCon.Add(iRccEN)
                    Else
                        'CONVERTIR ESTA LINEA EN REGISTRO CONTABLE DETALLE
                        Dim iRcdEN As New SuperEntidad
                        iRcdEN = iRcdRN.ConvertirTextoARegistroCompraDeta(iLineaActual)
                        'PASAR ESTA CABECERA A LA LISTA iLisAsi
                        iLisRegCon.Add(iRcdEN)
                    End If
                End If
            End If
        End While
    ...
    Sub EliminarRegistrosContablesFueraDeRango()
        ...
        Dim iLisRegCon As List(Of SuperEntidad) = Me.ConvertirTextoARegistroCompras
    ...
    Sub ImportarRegistrosCompra()
        ...
        Dim iNroObj As Integer = iLisRegCon.Count

        'LISTA DONDE SE ARMARAN CADA REGISTRO CONTABLE Y SU DETALLE
        'UNO A UNO
        Dim iLisAsi As New List(Of SuperEntidad)

        For Each xRegCon As SuperEntidad In iLisRegCon
            iContador += 1
...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Me.ImportarRegistrosCompra()
        MsgBox("Proceso de Importacion realizado correctamente")
    End Sub
End Class