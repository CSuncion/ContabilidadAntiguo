...
Public Class WImpCeCoXIngresoDetalle
    ...
    Sub Imprimir()
        ...
        ds.RegContab.Clear()
        'Llenar Cabecera()
        periodo = CType(Me.CrCeCoXIngresoDetalle1.Section2.ReportObjects.Item("Periodo"), CrystalDecisions.CrystalReports.Engine.TextObject)
        periodo.Text = "Del mes de " + Me.txtDesMes.Text + " a " + Me.TxtDesMes1.Text + " del " + Me.txtAno.Text

        empresa = CType(Me.CrCeCoXIngresoDetalle1.Section2.ReportObjects.Item("Empresa"), CrystalDecisions.CrystalReports.Engine.TextObject)
        empresa.Text = Me.txtNomEmp.Text

        codcc = CType(Me.CrCeCoXIngresoDetalle1.Section2.ReportObjects.Item("codcc"), CrystalDecisions.CrystalReports.Engine.TextObject)
        codcc.Text = Me.txtCodCcDes.Text

        ceco = CType(Me.CrCeCoXIngresoDetalle1.Section2.ReportObjects.Item("ceco"), CrystalDecisions.CrystalReports.Engine.TextObject)
        ...
        ilisRes = iRegConDetRN.ListarReporteCentroCostoXIngresoDetalle(iRegConDetEN)
        ...
        Me.CrCeCoXIngresoDetalle1.SetDataSource(ds)
