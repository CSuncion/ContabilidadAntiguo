...
Public Class WFlujoCaja
    ...
    Public titulo As String = "FlujoCaja"
...
#Region "Metodos"
    ...
    Sub permisoVentana()
        Dim nReg As Integer = Me.DgvFlu.Rows.Count
    ...
    Sub ActualizarVentana()
        '//
        Me.ActualizarDgvTab()
        Dgv.actualizarBarraEstado(Me.sst1, Me.DgvFlu)
        acc.EstadoBotonesPorGrilla(Me.ListaBotones, Me.DgvFlu)
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvFlu)
        Dgv.pintarColumnaDgv(Me.DgvFlu, ent.CampoOrden)
        Me.permisoVentana()
        '\\
    End Sub
    ...
    Sub ActualizarDgvTab()
        ...
        lista = Flu.obtenerFlujoCajaExisXEmpresa(ent)

        '/Refrescando el DataSource de DgvUsu
        Dgv.refrescarFuenteDatosGrilla(Me.DgvFlu, lista)
        '/Creando las columnas
        Dgv.asignarColumnaText(Me.DgvFlu, cam.CodFluCaj, "Codigo", 60)
        Dgv.asignarColumnaText(Me.DgvFlu, cam.NomFluCaj, "Nombre", 290)
        Dgv.asignarColumnaText(Me.DgvFlu, cam.EstFluCaj, "Estado", 110)
        Dgv.asignarColumnaTextVis(Me.DgvFlu, cam.ClaFluCaj, "Clave", 60, 0)
        '//
    End Sub
    ...
    Sub adicionar()
        '//
        Dim win As New WEditarFlujoCaja
        win.wFlu = Me
        win.operacion = 0
        Me.AddOwnedForm(win)
    ...
    Sub modificar()
        ...
        Dim cod As String = Dgv.obtenerValorCelda(Me.DgvFlu, cam.ClaFluCaj)
...
#End Region
    ...
    Private Sub DgvDis_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvFlu.CellEnter
        acc.EstadoBotonesPorFillaGrilla(Me.ListaBotones, Me.DgvFlu)
    End Sub

    Private Sub DgvDis_ColumnHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DgvFlu.ColumnHeaderMouseClick
        ent.CampoOrden = Me.DgvFlu.Columns(e.ColumnIndex).Name
        ent.ColumnaBusqueda = Me.DgvFlu.Columns(e.ColumnIndex).HeaderText
        Me.ActualizarVentana()
    End Sub
    ...
    Private Sub btnDesplaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrimero.Click, btnAnterior.Click, btnSiguiente.Click, btnUltimo.Click
        Dgv.desplazamientoFila(Me.DgvFlu, CType(sender, ToolStripButton))
    End Sub
