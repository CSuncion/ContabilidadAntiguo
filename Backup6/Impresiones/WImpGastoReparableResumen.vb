...
Public Class WImpGastoReparableResumen
    ...
    Sub Imprimir()
        ...
        ds.FlujoCaja.Clear()
        'Llenar Cabecera()
        periodo = CType(Me.CrGastoReparableResumen1.Section2.ReportObjects.Item("Periodo"), CrystalDecisions.CrystalReports.Engine.TextObject)
        periodo.Text = "Del mes de " + Me.txtDesMes.Text + " a " + Me.TxtDesMes1.Text + " del " + Me.txtAno.Text

        empresa = CType(Me.CrGastoReparableResumen1.Section2.ReportObjects.Item("Empresa"), CrystalDecisions.CrystalReports.Engine.TextObject)
        ...
        ilisRes = iRegConDetRN.ListarReporteXGastoReparableResumen(iRegConDetEN)
        ...
        Me.CrGastoReparableResumen1.SetDataSource(ds)
        'Cargamos en nuestro formulario el cr
        Me.crv1.ReportSource = Me.CrGastoReparableResumen1
