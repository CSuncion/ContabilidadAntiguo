...
Public Class WEditarVentana
#Region "Propietarios"
      Public wVen As New WVentana
#End Region
...
#Region "Metodos"
      ...
      Sub ventanaAdicionar()
            ...
            Me.Text = "Agregar " + Me.wVen.titulo
      ...
      Sub ventanaModificar(ByRef codigo As String)
            ...
            Me.InicializaVentana()
            'titulo de la ventana
            Me.Text = "Modificar " + Me.wVen.titulo
      ...
      Sub ventanaEliminar(ByRef codigo As String)
            ...
            Me.InicializaVentana()
            'titulo de la ventana
            Me.Text = "Eliminar " + Me.wVen.titulo
            'mostrar el registro en pantalla
            Me.obtenerItemTablaEnPantalla(codigo)
            'foco
            Me.btnAceptar.Focus()
      ...
      Sub ventanaVisualizar(ByRef codigo As String)
            ...
            Me.InicializaVentana()
            'titulo de la ventana
            Me.Text = "Visualizar " + Me.wVen.titulo
            'mostrar el registro en pantalla
            Me.obtenerItemTablaEnPantalla(codigo)
            'foco
            Me.btnAceptar.Focus()
      ...
      Sub obtenerItemTablaEnPantalla(ByRef cod As String)
            ...
            ent.CodigoVentana = cod
            ent = ven.buscarVentanaExisPorCodigo(ent)
            'preguntar si ent tiene el registro
            If ent.CodigoVentana = "" Then
                  Exit Sub
            Else
                  '/Pasar Datos a los controles
                  Me.txtCod.Text = ent.CodigoVentana
                  Me.txtNom.Text = ent.NombreVentana
            End If
            '\\
      End Sub
      ...
      Sub Aceptar()
            ...
            If Me.operacion = 1 Or Me.operacion = 2 Then
                  ...
                  ent.CodigoVentana = Me.txtCod.Text.Trim
                  ent = ven.buscarVentanaExisPorCodigo(ent)
            End If

            ent.CodigoVentana = Me.txtCod.Text.Trim
            ent.NombreVentana = Me.txtNom.Text.Trim
            ...
            Select Case Me.operacion
                  ...
                  Case 0
                        'Nuevo registro
                        ven.nuevoVentana(ent)
                        MsgBox(Me.wVen.titulo + " ingresado correctamente", MsgBoxStyle.Information, Me.wVen.titulo)
                  ...
                  Case 1
                        'Modificar Registro
                        ven.modificarVentana(ent)
                        MsgBox(Me.wVen.titulo + " modificado correctamente", MsgBoxStyle.Information, Me.wVen.titulo)
                        Me.Close()

                  Case 2
                        'Comprobar si es eliminable esata ventana
                        If Me.EsVentanaEliminable = False Then Exit Sub

                        'eliminamos al usuario pero logicamente
                        ven.eliminarVentanaTablaFis(ent)
                        MsgBox(Me.wVen.titulo + " Eliminado correctamente", MsgBoxStyle.Information, Me.wVen.titulo)
                        Me.Close()

            End Select
            '/Actualizar y buscar el registro grabado
            Me.wVen.ActualizarVentana()
            Dgv.obtenerCursorActual(Me.wVen.DgvVen, ent.CodigoVentana, Me.wVen.lista)
            '\\
      End Sub

      Function EsVentanaEliminable() As Boolean
            Dim oVO As New SuperEntidad
            Dim lisVO As New List(Of SuperEntidad)
            oVO.CodigoVentana = Me.txtCod.Text.Trim
            lisVO = vo.obtenerVentanaOpcionesExisXVentana(oVO)

            If lisVO.Count = 0 Then
                  Return True
            Else
                  MsgBox("Esta ventana no se puede eliminar", MsgBoxStyle.Exclamation, Me.wVen.titulo)
                  Return False
            End If
...
#End Region
      ...
      Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
            ...
            If Me.operacion = 2 Then
                  Dim rpta As Integer = MsgBox("Deseas eliminar este registro", MsgBoxStyle.YesNo, Me.wVen.titulo)
      ...
      Private Sub btnCancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancelar.Click
            If Me.operacion = 3 Then
                  Me.Close()
            Else
                  Dim rpta As Integer = MsgBox("Deseas cancelar la operacion", MsgBoxStyle.YesNo, Me.wVen.titulo)
                  If rpta = MsgBoxResult.Yes Then
                        Me.Close()
                  Else
                        Exit Sub
      ...
      Private Sub txtCod_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtCod.Validating
            If Me.operacion = 0 Then
                  ...
                  Else
                        ...
                        obj.CodigoVentana = Me.txtCod.Text.Trim
                        'Se busca en toda la tabla
                        obj = ven.buscarVentanaExisPorCodigo(obj)
                        If obj.CodigoVentana <> "" Then
                              MsgBox("Este codigo ya existe", MsgBoxStyle.Information, Me.wVen.titulo)
                              Me.txtCod.Text = ""
                              Txt.cursorAlUltimo(Me.txtCod)
                              e.Cancel = True
                        Else
