...
Public Class WExportarRegistroMayor
...
#Region "Metodos"
    ...
    Sub hilo1()
        ...
        iMcdEN.CodigoEmpresa = Me.TxtCodEmp.Text.Trim
        iMcdEN.PeriodoRegContabCabe = Me.txtAno.Text.Trim + Me.txtCodMes.Text.Trim
        iMcdEN.CampoOrden = cam.CodCtaPcge
        Dim iLisRcc As List(Of SuperEntidad) = iMcdRN.obtenerMovimientoDetalleXPeriodo(iMcdEN)
