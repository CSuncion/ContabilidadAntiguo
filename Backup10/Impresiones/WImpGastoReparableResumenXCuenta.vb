...
Public Class WImpGastoReparableResumenXCuenta

    Dim cam As New CamposEntidad
    Dim ds As New DataSet1
    Dim acc As New Accion
    Dim empresa, periodo, cue, cod As CrystalDecisions.CrystalReports.Engine.TextObject
    ...
    Sub Imprimir()
        ...
        ds.FlujoCaja.Clear()
        'Llenar Cabecera()
        periodo = CType(Me.CrGastoReparableResumenXCuenta1.Section2.ReportObjects.Item("Periodo"), CrystalDecisions.CrystalReports.Engine.TextObject)
        periodo.Text = "Del mes de " + Me.txtDesMes.Text + " a " + Me.TxtDesMes1.Text + " del " + Me.txtAno.Text

        empresa = CType(Me.CrGastoReparableResumenXCuenta1.Section2.ReportObjects.Item("Empresa"), CrystalDecisions.CrystalReports.Engine.TextObject)
        empresa.Text = Me.txtNomEmp.Text

        cue = CType(Me.CrGastoReparableResumenXCuenta1.Section2.ReportObjects.Item("cue"), CrystalDecisions.CrystalReports.Engine.TextObject)
        cue.Text = Me.txtNomCue.Text

        cod = CType(Me.CrGastoReparableResumenXCuenta1.Section2.ReportObjects.Item("cod"), CrystalDecisions.CrystalReports.Engine.TextObject)
        cod.Text = Me.txtCodCue.Text
        ...
        Me.CrGastoReparableResumenXCuenta1.SetDataSource(ds)
        'Cargamos en nuestro formulario el cr
        Me.crv1.ReportSource = Me.CrGastoReparableResumenXCuenta1
