...
Public Class WImpGastoReparableDetalleXOrigen
    ...
    Sub Imprimir()
        ...
        ds.RegContab.Clear()
        'Llenar Cabecera()
        periodo = CType(Me.CrGastoReparableDetalleXOrigen1.Section2.ReportObjects.Item("Periodo"), CrystalDecisions.CrystalReports.Engine.TextObject)
        periodo.Text = "Del mes de " + Me.txtDesMes.Text + " a " + Me.TxtDesMes1.Text + " del " + Me.txtAno.Text

        empresa = CType(Me.CrGastoReparableDetalleXOrigen1.Section2.ReportObjects.Item("Empresa"), CrystalDecisions.CrystalReports.Engine.TextObject)
        ...
        iRegConDetEN.CampoOrden = cam.CodOriRC + "," + cam.CodGasRep
        ...
        For Each obj As SuperEntidad In ilisRes
            ...
            If obj.CodigoGastoReparable.Length = 8 Then
                NewRow = ds.RegContab.NewRegContabRow
                NewRow.CodigoOrigen = obj.CodigoOrigen
                NewRow.NombreOrigen = obj.NombreOrigen
        ...
        Me.CrGastoReparableDetalleXOrigen1.SetDataSource(ds)
        'Cargamos en nuestro formulario el cr
        Me.crv1.ReportSource = Me.CrGastoReparableDetalleXOrigen1
        '/
    End Sub
...
#End Region
    ...
    'Private Sub TxtCodGasRepDes_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.KeyCode = Keys.F1 Then
    ...
    'Private Sub TxtCodGasRepDes_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    Me.EsGastoReparableDesdeValido()
    'End Sub

    'Private Sub TxtCodGasRepHas_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '    Me.EsGastoReparableHastaValido()
    'End Sub

    'Private Sub TxtCodGasRepHas_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.KeyCode = Keys.F1 Then
    '        Dim win As New WListarGastoReparable
    '        win.titulo = "Codigo Almacen"
    '        win.tabla = "CodigoAlmacen"
