...
#End Region
    ...
    Sub Imprimir()
        ...
        For Each obj As SuperEntidad In listarfc
            ...
            NewRow.CodigoAlmacen = obj.CodigoGastoReparable
            'Si Debe / Haber 
        ...
        Next
        CrRptVoucher2.SetDataSource(ds)
        'Cargamos en nuestro formulario el cr
        Me.crv1.ReportSource = CrRptVoucher2
