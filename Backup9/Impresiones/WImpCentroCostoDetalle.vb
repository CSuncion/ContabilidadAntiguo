...
Public Class WImpCentroCostoDetalle
    ...
    Dim cr As New CrCentroCostoDetalle
    ...
    Sub Imprimir()
        ...
        iRegConDetEN.DatoFiltro5 = Me.TxtCodCta.Text.Trim
        iRegConDetEN.DatoFiltro6 = Me.txtCodCue2.Text.Trim
        iRegConDetEN.CampoOrden = cam.CodCC + "," + cam.CodCtaPcge + "," + cam.DebHabRCD
        Dim ilisRes As New List(Of SuperEntidad)
        ilisRes = iRegConDetRN.ListarRegistrosContablesDetalleXFiltroCentroCostoDetalle(iRegConDetEN)
        ...
        If Me.rbtAnaIndividual.Checked = True Or Me.rbtAnaTodos.Checked = True Then
            ...
            Select Case Auto
                Case "Todas"
                    ...
                    Me.TxtCodCta.Clear()
                    Me.TxtNomCta.Text = ""
                    Me.txtCodCue2.Enabled = False
                    Me.txtCodCue2.Clear()
                    Me.txtNomCue2.Text = ""
                Case "Rango"
                    Me.TxtCodCta.Enabled = True
                    Me.txtCodCue2.Enabled = True
                    Me.TxtNomCta.Text = ""
                    Me.txtNomCue2.Clear()
            End Select
        End If
...
#End Region
    ...
    Private Sub TextBox2_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtCodCue2.Validating
