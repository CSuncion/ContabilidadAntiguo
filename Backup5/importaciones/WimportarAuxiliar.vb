...
Public Class WimportarAuxiliar
        ...
        If Me.dgvExcel.Rows.Count <> 1 Then
            For n As Integer = 0 To Me.dgvExcel.Rows.Count - 2
                ...
                If Me.dgvExcel.Item(0, n).Value.ToString <> "" Then
                    ...
                    entd.CodigoAuxiliar = Me.dgvExcel.Item(0, n).Value.ToString
                    entd.DescripcionAuxiliar = Me.dgvExcel.Item(1, n).Value.ToString
                    entd.DireccionAuxiliar = Me.dgvExcel.Item(2, n).Value.ToString
                    entd.TelefonoAuxiliar = Me.dgvExcel.Item(4, n).Value.ToString
                    entd.TipoAuxiliar = Me.dgvExcel.Item(5, n).Value.ToString
                    If entd.TipoAuxiliar = "" Then
                        If entd.CodigoAuxiliar.Substring(0, 2) = "20" Then
                            entd.TipoAuxiliar = "2"
                        Else
                            entd.TipoAuxiliar = "1"
                        End If
                    End If
                    entd.TipoDocumentoAuxiliar = Me.dgvExcel.Item(17, n).Value.ToString
                    entd.CelularAuxiliar = ""
                    entd.CorreoAuxiliar = ""
                    entd.ReferenciaAuxiliar = ""
                    entd.ApellidoPaternoAuxiliar = Me.dgvExcel.Item(18, n).Value.ToString
                    entd.ApellidoMaternoAuxiliar = Me.dgvExcel.Item(19, n).Value.ToString
                    entd.PrimerNombreAuxiliar = Me.dgvExcel.Item(20, n).Value.ToString
                    entd.SegundoNombreAuxiliar = Me.dgvExcel.Item(21, n).Value.ToString
                    entd.Exporta = "0"
                    entd.EstadoAuxiliar = "1"
                    aux.nuevoAuxiliar(entd)
                End If
