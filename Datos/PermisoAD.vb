...
Public Class PermisoAD
      ...
      Sub SetParametros(ByRef ent As SuperEntidad)
            ...
            Sql.AsignarParametro(Par.OpcionPermiso, ent.OpcionPermiso)
            'Estado
      ...
      Function Objeto(ByRef iDr As IDataReader) As SuperEntidad
            ...
            objEnc.OpcionPermiso = CType(iDr(Campo.OpcPer).ToString, Integer)
      ...
      Function ObjetoEspecial(ByRef iDr As IDataReader) As SuperEntidad
            '//
            Dim objEnc As New SuperEntidad
            objEnc.CodigoUsuario = iDr(Campo.CodUsu).ToString
            objEnc.CodigoVentana = iDr(Campo.CodVen).ToString
      ...
      Sub SpNuevoPermiso(ByRef ent As SuperEntidad)
            '//
            Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)

            Sql.ComandoProcAlm("SpNuevoPermiso")
            '/Asignar Parametros
    ...
    Sub SpModificarPermiso(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpModificarPermiso")
            '/Asignar Parametros
            Me.SetParametros(ent)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
    ...
    Sub SpEliminarPermiso(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpEliminarPermiso")
            Sql.AsignarParametro(Par.CodigoUsuario, ent.CodigoUsuario)
            Sql.AsignarParametro(Par.CodigoOpcion, ent.CodigoOpcion)
            Sql.AsignarParametro(Par.CodigoVentana, ent.CodigoVentana)
            '/Ejecutar sin resultado
    ...
    Sub SpEliminarPermisosDeUsuario(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpEliminarPermisosDeUsuario")
            Sql.AsignarParametro(Par.CodigoUsuario, ent.CodigoUsuario)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
        Catch ex As Exception
    ...
    Function SpObtenerRegistrosConUnaCondicionEspecial(ByRef ent As SuperEntidad) As List(Of SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpObtenerRegistrosConUnaCondicion")
            ...
            While iDr.Read
                'Adicionando cada grupo a la Lista
                Lista.Add(Me.ObjetoEspecial(iDr))
            End While
            Return Lista
        Catch ex As Exception
            MsgBox(ex.Message) : Return Lista
