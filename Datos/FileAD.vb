...
Public Class FileAD
    ...
    Sub SpNuevoFile(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpNuevoFile")
            '/Asignar Parametros
    ...
    Sub SpModificarFile(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpModificarFile")
            '/Asignar Parametros
            Me.SetParametros(ent)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
    ...
    Sub SpEliminarFile(ByRef ent As SuperEntidad)
        '//
        Try
            Sql.Conectar(SqlDatos.Bd.ContabilidadEmma)
            Sql.ComandoProcAlm("SpEliminarFile")
            '/Asignar Parametro
            Sql.AsignarParametro(Par.ClaveFile, ent.ClaveFile)
            '/Ejecutar sin resultado
            Sql.EjecutarSinResultado()
